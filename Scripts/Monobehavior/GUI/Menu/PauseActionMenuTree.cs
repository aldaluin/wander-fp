...
namespace Goldraven.Gui {
    ...
    public class PauseActionMenuTree : MonoBehaviour {
         ...
         *  cmcb 2019/10/27
         *
         *  Add a second pause control for an actions menu.
         *
         */
        ...
        // Singleton
        public static PauseActionMenuTree only { get; private set; }
        ...
        public ActionMenuManager ActionMenu;
